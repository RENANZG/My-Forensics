...
# USAGE:
#  Make it executable:
#   $ sudo chmod +x ~/Downloads/Dust3d_AppImage.sh
#  Then run
#   $ sudo bash ~/Downloads/Dust3d_AppImage.sh
########################################################################
...
version=$(curl -Ls https://api.github.com/repos/huxingyi/dust3d/releases | sed 's/[()",{} ]/\n/g' | grep -oi "https.*mage$" | grep -vi "i386|i686|aarch64|arm64|armv7l" | head -1)
wget "$version" || exit 1
